...
def compute_relevance_score(
    ...
    relevance_summary_df.to_csv(os.getcwd() + "/outputs/covid_data/covid_data_metrics/relevance_results/relevance_summary.csv")
    # entities
    ...
    matched_entities_df.to_csv(os.getcwd() + "/outputs/covid_data/covid_data_metrics/relevance_results/matched_entities.csv")
    # relations
    ...
    matched_relations_df.to_csv(os.getcwd() + "/outputs/covid_data/covid_data_metrics/relevance_results/matched_relations.csv")
